    ...
    <header className="sticky top-0 z-40 border-b border-gray-200 bg-white/95 backdrop-blur">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-2 sm:px-4">
        ...
        <div className="flex items-center gap-2 sm:gap-5">
          <Link
            href="/"
            className="whitespace-nowrap py-3 text-base font-extrabold text-gray-800 sm:text-lg"
          >
            シフらく
          </Link>
            ...
            {NAV_ITEMS.map((item) => {
              ...
              return (
                <Link
                  ...
                  className={`relative whitespace-nowrap px-2 py-3 text-xs font-medium transition-colors sm:px-3 sm:text-sm ${
                    isActive
                      ? "text-blue-700"
