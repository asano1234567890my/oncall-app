...
**V2.1完了 → Phase1「売り物にする」進行中（P1-1〜P1-3/P1-5/P1-7/P1-7b/P1-9〜P1-18完了）**
<!-- P1-18: メアド必須化+CORS修正+メアド確認編集UI+病院名変更API+DefaultPageSetting廃止+将来要件ドキュメント -->
...
- **短期（今月〜来月）**: ~~CORS修正+メアド必須化~~ ✅完了 → 開発者管理ページ(P1-19) → AIガイド(P1-20/21) → 自院実運用+知り合い5施設
